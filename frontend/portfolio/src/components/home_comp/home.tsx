            ...
            <div className="homemaindiv">
                ...
                <div className="homemaindetails">
                    ...
                    <div className="buttondiv">
                        <ButtonComp text="Download CV" target="_blank" hrefroute="../assets/files/Blessen_Vinoy_Mathew.pdf" className={`${darkMode ? 'darkmodebutton' : 'lightmodebutton'}`}/>
                        <ButtonComp text="Contact Info" hrefroute="#contact" className={`${darkMode ? 'darkmodetwobutton' : 'lightmodetwobutton'}`}/>
                    </div>
